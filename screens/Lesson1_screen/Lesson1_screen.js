...
import Questions_1 from '../../assets/Questions_1';
...
const Lesson1_screen = ({ navigation }) => {

  const [current_Question_Number, set_current_Question_Number] = useState(0);
  const [current_Question, set_current_Question] = useState(Questions_1[current_Question_Number]);
  ...
  useEffect(() => {
    if (current_Question_Number >= Questions_1.length) {
      if (lives < 1) {
      ...
      set_current_Question(Questions_1[current_Question_Number]);
    }
  ...
  return (
    ...
    <Header 
      progress={current_Question_Number / Questions_1.length} 
      lives={lives}
    />
